...
const GoogleAdsLandingPage = () => {
  ...
  const content = language === 'it' ? {
    ...
    testimonials: [
      {
        quote: 'Thanks to their campaign management, we have seen a significant increase in our online sales. The team is always available and proactive.',
        author: 'Mark Johnson, CEO of Digital Solutions'
      },
      {
        quote: 'Finally a transparent and results-oriented campaign management. Highly recommended!',
        author: 'Laura Smith, Marketing Manager at Tech Innovations'
      }
    ],
    ...
    <div className="bg-white">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p 
            className="text-center text-gray-600 max-w-3xl mx-auto mb-12 text-lg"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {content.testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="text-blue-700 font-medium">- {testimonial.author}</p>
              </motion.div>
            ))}
          </div>
        </div>
